...
export class PlatformService {
  ...
  async bootstrap(input: {
    ...
    const password_hash = await argon2.hash(input.owner_password, {
      ...
      async (tx: Prisma.TransactionClient) => {
        ...
        if (existingMembership) {
          throw new BadRequestException(
            'User already has a company membership',
          );
        }
        ...
        const perms = [
          ...
          {
            key: 'PLATFORM_COMPANY_CREATE',
            module: 'PLATFORM',
            action: 'CREATE',
          },
          {
            key: 'PLATFORM_COMPANY_UPDATE',
            module: 'PLATFORM',
            action: 'UPDATE',
          },
          ...
          {
            key: 'HR_EMPLOYMENT_READ',
            module: 'HR_EMPLOYMENT',
            action: 'READ',
          },
          {
            key: 'HR_EMPLOYMENT_CREATE',
            module: 'HR_EMPLOYMENT',
            action: 'CREATE',
          },
          {
            key: 'HR_EMPLOYMENT_UPDATE',
            module: 'HR_EMPLOYMENT',
            action: 'UPDATE',
          },
          {
            key: 'HR_EMPLOYMENT_DELETE',
            module: 'HR_EMPLOYMENT',
            action: 'DELETE',
          },
          {
            key: 'HR_EMPLOYMENT_EXPORT',
            module: 'HR_EMPLOYMENT',
            action: 'EXPORT',
          },
          {
            key: 'HR_EMPLOYMENT_IMPORT',
            module: 'HR_EMPLOYMENT',
            action: 'IMPORT',
          },
